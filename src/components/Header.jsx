...
const Header = () => {
  return (
    <header class=" bg-black  text-white shadow-lg hidden md:block top-2 z-10 sticky mb-10 border rounded-full mt border-white hover:shadow-indigo-500/40 ">
