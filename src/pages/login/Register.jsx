...
function Register  ()  {
    ...
    const handleSubmit= (e)=> {
        e.preventDefault()
        axios.post('',{name,prn,email,password}).then(result=>console.log(result)).catch(err=>console.log(err))
    }

  return (
    <div className="bg-white">
      <p>Student Login</p>
      <form onSubmit={handleSubmit} action="" class="flex flex-col gap-2">
