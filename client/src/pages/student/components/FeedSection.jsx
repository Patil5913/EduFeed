    ...
    <>
      <div className=" w-full min-h-full flex justify-center items-center flex-col my-8">
        ...
        <div className=" mt-5 flex flex-col justify-center items-center px-5 py-5 gap-5 sm:flex-row">
          <div class=" w-[300px] h-fit rounded-3xl  overflow-hidden z-[100] relative cursor-pointer snap-start shrink-0 py-8 px-6 bg-primary flex flex-col items-center justify-center gap-3 transition-all duration-300 group border-2 border-black">
